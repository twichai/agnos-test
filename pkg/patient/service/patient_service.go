...
func (u *patientUsecase) Search(ctx context.Context, req *entity.SeachPatientRequest, hospitalID string) ([]*entity.Patient, error) {
	return u.repo.Search(ctx, req, hospitalID)
}
